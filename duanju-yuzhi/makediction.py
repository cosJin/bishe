...
with open('cleaned_train0-400.txt', 'rb') as inp:
    texts1 = inp.read().decode('utf-16')
texts1=texts1.replace('\r\r\n','')
all_dic1 = re.split('[a-zA-Z0-9，。！？、\(\)\〔‘’“”：；『[●V\（【】\）\〕{}—《》 」…「一─�』\]]', texts1)
with open('cleaned_train400-800.txt', 'rb') as inp:
    texts2 = inp.read().decode('utf-16')
texts2=texts2.replace('\r\r\n','')
all_dic2 = re.split('[a-zA-Z0-9，。！？、\(\)\〔‘’“”：；『[●V\（【】\）\〕{}—《》 」…「一─�』\]]', texts2)
with open('cleaned_train800-1160.txt', 'rb') as inp:
    texts3 = inp.read().decode('utf-16')
texts3=texts3.replace('\r\r\n','')
all_dic3 = re.split('[a-zA-Z0-9，。！？、\(\)\〔‘’“”：；『[●V\（【】\〕\〕{}—《》 」…「一─�』\]]', texts3)
# all_dic=['你好','我们','你们','大家','当','且','你是谁','我的天','拖']
all_dic=all_dic1+all_dic2+all_dic3
dic=[]
